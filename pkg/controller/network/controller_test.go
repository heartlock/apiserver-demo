...
import (
	...
	. "github.com/heartlock/apiserver-demo/pkg/client/clientset_generated/clientset/typed/batch/v1beta1"
...
var _ = Describe("Network controller", func() {
	...
	BeforeEach(func() {
		...
		expectedKey = "network-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.BatchV1beta1Client.Networks("network-controller-test-handler")
