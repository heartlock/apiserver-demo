...
import (
	"github.com/heartlock/apiserver-demo/pkg/client/clientset_generated/internalclientset/scheme"
...
func (c *BatchClient) Networks(namespace string) NetworkInterface {
	return newNetworks(c, namespace)
}

func (c *BatchClient) NetworkSpecs(namespace string) NetworkSpecInterface {
	return newNetworkSpecs(c, namespace)
}

func (c *BatchClient) NetworkStatuses(namespace string) NetworkStatusInterface {
	return newNetworkStatuses(c, namespace)
}
