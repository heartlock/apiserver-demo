...
import (
	v1beta1 "github.com/heartlock/apiserver-demo/pkg/apis/batch/v1beta1"
	"github.com/heartlock/apiserver-demo/pkg/client/clientset_generated/clientset/scheme"
...
// BatchV1beta1Client is used to interact with features provided by the batch.heartlock.io group.
type BatchV1beta1Client struct {
	restClient rest.Interface
}

func (c *BatchV1beta1Client) Networks(namespace string) NetworkInterface {
