...
import (
	...
	scheme "github.com/heartlock/apiserver-demo/pkg/client/clientset_generated/clientset/scheme"
...
func newNetworks(c *BatchV1beta1Client, namespace string) *networks {
	return &networks{
		client: c.RESTClient(),
		ns:     namespace,
	}
